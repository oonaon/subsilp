...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">'.Yii::t('common/org', Yii::$app->session['organize'].'-shortname').'</span><span class="logo-lg">' . Yii::t('common/org', Yii::$app->session['organize'].'-title') . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<?= $dir ?>/img/user2-160x160.jpg" class="img-circle"
                                                 alt="User Image"/>
                                        </div>
                                        <h4>
                                            Support Team
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<?= $dir ?>/img/user3-128x128.jpg" class="img-circle"
                                                 alt="user image"/>
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<?= $dir ?>/img/user4-128x128.jpg" class="img-circle"
                                                 alt="user image"/>
                                        </div>
                                        <h4>
                                            Developers
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?= $dir ?>/img/user2-160x160.jpg" class="user-image" alt="User Image"/>
